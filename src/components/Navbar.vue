    ...
    <div class="navbar">
        <nav class="deep-purple">
            <div class="nav-wrapper">
                <a v-if="user" class="brand-logo center left"><img width="120px" src="../assets/logoWhite.png"></a>
                <ul class="right">
                    ...
                    <li v-if="user"><a class="btn-floating waves-effect waves-light deep-purple" @click="logout" title="Logout" ><i class="material-icons">exit_to_app</i></a></li>
                </ul>
            </div>
        </nav>
        <sidebar>
...
export default {
    ...
    methods: {
        ...
        reset() {
            objet.assign(this.$data, this.$options.data.apply(this));
        }
    },
    created() {
...
<style>
body {
    background-image: url("../assets/logoGrey.png");
